...
class MyPanel1 extends wxPanel {
	...
	function __construct( $parent=null ){
		...
		$this->about_desc = new wxStaticText( $this, wxID_ANY, "ABOUT", wxDefaultPosition, wxDefaultSize, 0 );
		$this->about_desc->Wrap( -1 );
		$this->about_desc->SetFont( new wxFont( 20, 70, 90, 92, false, wxEmptyString ) );
		
		$bSizer11->Add( $this->about_desc, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5 );
		
		$this->about_text = new wxStaticText( $this, wxID_ANY, "lorem ipsum dolar sit amet lorem ipsum dolar sit amet lorem ipsum dolar sit amet lorem ipsum dolar sit amet lorem ipsum dolar sit amet lorem ipsum dolar sit amet lorem ipsum dolar sit amet ", new wxPoint( -1,-1 ), new wxSize( 300,-1 ), 0 );
		$this->about_text->Wrap( 1 );
		$bSizer11->Add( $this->about_text, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5 );
